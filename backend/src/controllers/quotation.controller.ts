...
export class QuotationController {
   ...
   * @param next 次のミドルウェア
   */
  static async generateQuotation(req: Request, res: Response, next: NextFunction): Promise<Response | void> {
    try {
   ...
   * @param next 次のミドルウェア
   */
  static async generateQuotationPdf(req: Request, res: Response, next: NextFunction): Promise<Response | void> {
    try {
      const userId = req.user?._id;
